...
public class NumberButtonGeneratorForCenterCenter : MonoBehaviour
{
    // ボタンのプレファブ
    ...
    public static bool exist_3buttons = false;
    ...
    public void GenerateForCenterCenterCenter()
    {
        /*if (!NumberButtonGeneratorForLeft.exist_1buttons||
            !NumberButtonGeneratorForCenterLeft.exist_2buttons||
            !NumberButtonGeneratorForCenterCenter.exist_3buttons||
            !NumberButtonGeneratorForCenterRight.exist_4buttons||
            !NumberButtonGeneratorForRight.exist_5buttons)*/
        if(!exist_3buttons)
        {
            //いったんボタン削除
            ...
            //ボタン生成
            this.GenerateNumberButtonsForCenterCenter(1, 6);
            ...
            NumberButtonGeneratorForCenterCenter.exist_3buttons = true;
    ...
    public void GenerateNumberButtonsForCenterCenter(int rowCount, int colCount)
    {
        ...
        */
        ...
        for (int y = 0; y < rowCount; y++)
        {
            for (int x = 0; x < colCount; x++)
            {
                ...
                // ボタンの情報を設定
                var controller = button.GetComponent<NumberButtonControllerForCenterCenter>();
                controller.SetButtonInfosForCenterCenter(1, number.ToString());
