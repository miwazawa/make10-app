...
public class NumberButtonControllerForCenterLeft : MonoBehaviour
{
    ...
    // ボタンの情報を設定する
    public void SetButtonInfosForCenterLeft(int number, string text)
    {
        this.Text = text;
        this.Number = number;
    ...
    private void OnClick()
    {
        ...
        //ope(演算子)を適切な位置に挿入．左から2番目なので1番目
