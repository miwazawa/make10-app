...
public class NumberButtonControllerForLeft : MonoBehaviour
{
    //ボタンのインデックス
    int B_IDX = 0;
    // ボタンに表示されるテキストと数値
    ...
    // ボタンの情報を設定する
    public void SetButtonInfosForLeft(int number, string text)
    {
        this.Text = text;
        this.Number = number;
